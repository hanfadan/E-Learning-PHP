...
<head>
  ...
  <title>Login &mdash; E-Learning PHP</title>
  <!-- General CSS Files -->
...
<body>
      ...
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            ...
            <h4 class="text-dark font-weight-normal"><span class="font-weight-bold">E-Learning PHP</span></h4>
            ...
            <div class="text-center mt-5 text-small">
              Copyright &copy; 2020 E-Learning PHP  | Made with 💙 By : Portfolio Project
            </div>
        ...
        <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" data-background="stisla/assets/img/unsplash/login.jpg">
          <div class="absolute-bottom-left index-2">
            <div class="text-light p-5 pb-2">
              <div class="mb-5 pb-3">
                <h1 class="mb-2 display-4 font-weight-bold">Selamat Datang Di E-Learning PHP</h1>
                <h5 class="font-weight-normal text-muted-transparent">Jl. XYZ</h5>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="modal-content">
    <div class="modal-header">
      <h5 class="modal-title">Selamat Datang di E-Learning PHP</h5>
